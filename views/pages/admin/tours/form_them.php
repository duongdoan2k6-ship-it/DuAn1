...
<body class="bg-light">
                        ...
                        <div class="tab-pane fade show active" id="general">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="so_ngay" id="so_ngay" class="form-control" required min="1" value="1" oninput="renderItinerary()">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="card-body p-0">
                                    <div id="itinerary-container">
                                        <div class="alert alert-warning small">
                                            <i class="bi bi-arrow-left"></i> Vui lòng nhập <b>"Số ngày"</b> ở tab Thông tin chung trước.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">Chưa có nhà cung cấp nào. Hãy thêm ở menu Đối tác.</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
    ...
    <script>
    // Hàm tự động vẽ ô nhập lịch trình dựa trên số ngày
    function renderItinerary() {
        const days = document.getElementById('so_ngay').value;
        ...
        if (days && days > 0) {
                    ...
                    <div class="card mb-3 border bg-light shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-2">
                                ...
                                <input type="text" name="itinerary_title[]" class="form-control bg-white" placeholder="Nhập tiêu đề..." required>
                            </div>
                            <div class="mb-0">
                                <label class="form-label small fw-bold">Nội dung chi tiết</label>
                                <textarea name="itinerary_content[]" class="form-control bg-white" rows="2" placeholder="Chi tiết hoạt động..."></textarea>
                            </div>
                        </div>
                    </div>
                `;
            ...
            container.innerHTML = '<div class="alert alert-warning">Vui lòng nhập số ngày hợp lệ (>0).</div>';
        }
    }

    // Gọi hàm 1 lần khi trang vừa load xong để vẽ luôn (nếu có giá trị mặc định)
