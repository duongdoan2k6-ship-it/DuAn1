                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="d-flex align-items-center justify-content-center">
                                            <a href="index.php?controller=person&action=editPerson&id=<?= $item['MaHDV'] ?>"
                                                class="btn btn-link text-dark px-2 mb-0" title="Sửa">
                                                <i class="material-icons text-sm me-1">Sửa</i>
                                            </a>
                                            <a href="index.php?controller=person&action=delete-person&id=<?= $item['MaHDV'] ?>"
                                                onclick="return confirm('Xác nhận xóa HDV: <?= $item['HoTen'] ?>?');"
                                                class="btn btn-link text-danger text-gradient px-2 mb-0" title="Xoá">
                                                <i class="material-icons text-sm me-1">Xoá</i>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
